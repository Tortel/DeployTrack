...
public class NotificationService extends Service {
	...
	public void onCreate() {
		...
		showNotification();
		if(DEBUG) Toast.makeText(this, "NotificationService onCreate", Toast.LENGTH_SHORT).show();
	...
	public void onDestroy() {
		...
		if(DEBUG) Toast.makeText(this, "NotificationService onDestroy", Toast.LENGTH_SHORT).show();
	}
	...
	private void showNotification(){
		...
		if(DEBUG) Toast.makeText(this, "NotificationService loading notification", Toast.LENGTH_SHORT).show();
	...
	/**
	 * Load the ID for the deployment to be shown as a notification.
	 * Returns -1 if one isn't saved yet
	 */
